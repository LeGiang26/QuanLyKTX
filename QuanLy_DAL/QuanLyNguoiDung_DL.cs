...
namespace QuanLy_DAL
{
    public class QuanLyNguoiDung_DL : DataProvider
    {
        ...
        {
            string manguoidung, tendangnhap, matkhau, quyen;
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    QuanLyNguoiDung qlNguoiDung = new QuanLyNguoiDung(manguoidung, tendangnhap, matkhau, quyen);
        ...
        {
            string sql = "INSERT INTO NguoiDung (tendangnhap, matkhau, quyen) VALUES (@tendangnhap, @matkhau, @quyen)";
            try
            {
                Connect();
                ...
                cmd.Parameters.AddWithValue("@quyen", nguoiDung.quyen);
        ...
        {
            string sql = "UPDATE NguoiDung SET tendangnhap = @tendangnhap, matkhau = @matkhau, quyen = @quyen WHERE manguoidung = @manguoidung";
            try
            {
                Connect();
                SqlCommand cmd = new SqlCommand(sql, cn);
